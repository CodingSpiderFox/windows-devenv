...
$Reboot = "Reboot now?"
$InstallGData = "Remember to install G DATA USB Keyboard Guard"
...
Switch ($Prompt1) {
    ...
    Yes {
        ...
        #Prompt asking if you'd like to install G DATA USB Keyboard Guard
        $Prompt8 = [Windows.MessageBox]::Show($InstallGData, "Rubberducky prevention", $Button, $Warn)
        Switch ($Prompt8) {
            Yes {
                Write-Host "Done"
            }
